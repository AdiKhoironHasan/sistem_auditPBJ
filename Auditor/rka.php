...
include_once '../../functions/insert_data.php';
include '../../functions/connect.php';
$sql = mysqli_query($conn, "SELECT * FROM tb_rencana_kerja");
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="text-center">
                        ...
                        <a href="rka_delete.php?id=<?= $row["id_rka"] ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')" style="color: crimson;"><i class="far fa-trash-alt"></i></a>
                      </div>
                    </td>
                  </tr>
                <?php
