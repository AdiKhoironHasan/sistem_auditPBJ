            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td style="background-color: lightblue;">
                                <input type="text" name="masa_monitoring_awal" class="forn-control form-control-lg border-0 text-center bg-transparent" placeholder="ketik di sini" onfocus="(this.type='date')">
                            </td>
                        ...
                        <tr>
                            <td style="background-color: lightblue;">
                                <input type="text" name="masa_monitoring_akhir" class="forn-control form-control-lg border-0 text-center bg-transparent" placeholder="ketik di sini" onfocus="(this.type='date')">
                            </td>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td class="txt-up" style="background-color: lightblue;">
                                <input type="text" name="uji_coba_barang" class="form-control form-control-lg border-0 text-center bg-transparent" placeholder="ketik di sini">
                            </td>
                            <td></td>
                        </tr>
                        <tr>
