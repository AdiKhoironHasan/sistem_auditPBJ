...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <div class="mb-2">
                    <a href="visit-tambah.php" class="btn btn-secondary">Tambah</a>
                ...
                <table id="example1" class="table table-bordered table-striped text-center">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-center">
                                        <a href="timeline.php"><i class="fas fa-info-circle" style="color: deepskyblue;"></i></a>
                        ...
                        <?php
                            include "layouts/modal-visit-edit.php";
                            $no++;
                        endforeach
                        ?>
                    </tbody>
...
<?php include "layouts/modal-visit-tambah.php" ?>
