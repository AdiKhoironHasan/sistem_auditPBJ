        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <input type="hidden" name="masa_monitoring_awal" value="<?= $data_desk['masa_monitoring_awal'] ?>">
                    <input type="hidden" name="masa_monitoring_akhir" value="<?= $data_desk['masa_monitoring_akhir'] ?>">
