                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $row["nama"]; ?></td>
                                <td><?= $row["username"]; ?></td>
                                <td><span class="badge badge-<?php if ($row['level'] == "Ketua SPI"){echo "danger";}elseif($row['level'] == "Anggota SPI"){echo "secondary";}elseif($row['level'] == "Ketua Unit"){echo "primary";}elseif($row['level'] == "Direktur"){echo "success";} ?>"><?= $row["level"]; ?></span></td>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $row["username"]; ?></td>
                                <td><?= $row["level"]; ?></td>
                                <td><span class="badge badge-<?php if($row['status'] == "Tidak Aktif"){echo "danger";}elseif($row['status'] == "Mendaftar"){echo "primary";} ?>"><?= $row["status"]; ?></span></td>
                                <td>
                                    <div class="text-center">
                                        <div class="row">
                                            <div class="col">
